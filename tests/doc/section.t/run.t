  ...
  <span class="keyword">module</span> <a name="A_">A</a>
    ...
    <span class="keyword">let</span> <span class="keyword">rec</span> <a name="assoc_6">assoc</a> (xs : <a title="list.List.list" href="https://why3.lri.fr/stdlib/list.html#list_8">list</a> <a title="A.t" href="#t_3">t</a>) : <a title="A.t" href="#t_3">t</a> =
      <span class="section"><span class="comment">{</span><span class="attribute section-toggle">proof</span><span class="comment section-text active">…</span><span class="comment">}</span><span class="section-text"> <span class="keyword">variant</span> { xs } <span class="comment">{</span><span class="attribute section-toggle">qed</span><span class="comment">}</span></span></span>
      <span class="section"><span class="comment">{</span><span class="attribute section-toggle">Code</span><span class="comment section-text">…</span><span class="comment">}</span><span class="section-text active">
      <span class="keyword">match</span> xs <span class="keyword">with</span>
      <span class="section"><span class="comment">{</span><span class="attribute section-toggle">Nil case</span><span class="comment section-text active">…</span><span class="comment">}</span><span class="section-text">
      ...
      <span class="section"><span class="comment">{</span><span class="attribute section-toggle">Cons case</span><span class="comment section-text">…</span><span class="comment">}</span><span class="section-text active">
